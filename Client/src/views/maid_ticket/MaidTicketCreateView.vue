...
export default defineComponent({
    ...
    mounted() {
        ...
        this.getEmployees().then(data => {this.result.employeeId = (JSON.parse(JSON.stringify(data))[0].id)});
        this.getRooms().then(data => {this.result.roomId = (JSON.parse(JSON.stringify(data)).content[0].id)});
    },
