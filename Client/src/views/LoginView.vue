<template>
    <div class="max-w-xs grid min-w-full min-h-screen place-items-center">
        ...
        <div class="logo flex m-auto">
            ...
            <i class="material-icons" style="font-size:8rem;margin-top:1rem;margin-right:0.5rem">hotel</i>
            <div class="logo_name" style="font-size:6.5rem">SpurVaGo</div>
    
        </div>
    
        <div class="bg-neutral-50 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-1/3" style="margin-bottom: auto">
            ...
            <div class="mb-4">
              ...
              " id="email" type="text" placeholder="p.plizga@spurva.go" v-model= this.result.email />
            ...
            <div class="mb-6">
              ...
              " id="password" type="password" placeholder="********" v-model= this.result.password />
