            ...
            <tr class="bg-white">
              ...
              <td class="w-1/3 text-center py-3 px-4">
                <i
                  ...
                  @click="przejdz(1, 'Telewizor', 113, 'Zniszczona matryca')"
                  >description</i
                >
            ...
            <tr class="bg-gray-200">
              ...
              <td class="w-1/3 text-center py-3 px-4">
                <i
                  class="material-icons"
                  @click="
                    przejdz(2, 'Cieknący kran', 53, 'Woda cieknie z kranu')
                  "
                  >description</i
                >
                <i class="material-icons text-red-500" @click="alertDisplay"
            ...
            <tr id="3" class="bg-white">
              ...
              <td class="w-1/3 text-center py-3 px-4">
                <i
                  class="material-icons"
                  @click="
                    przejdz(3, 'Wybita szyba', 22, 'Szyba przy balkonie wybita')
                  "
                  >description</i
                >
                <i class="material-icons text-red-500" @click="alertDisplay"
